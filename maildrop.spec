...
wiadomo∂Ê, ktÛra ma byÊ dostarczona do skrzynki, opcjonalnie czyta
instrukcje z pliku jak filtrowaÊ przychodz±c± pocztÍ, na podstawie
tych instrukcji moøe dostarczaÊ pocztÍ do innej skrzynki, lub
forwardowaÊ zamiast wrzucaÊ do podstawowej skrzynki.

Maildrop uøywa strukturalnego, rzeczywistego meta-jÍzyka programowania
do definiowania instrukcji filtrowania. Podstawowe moøliwo∂ci s±
szybkie i wydajne. Na serwerach z niewielkim obci±øeniem moøna uøywaÊ
bardziej zaawansowanych, obci±øaj±cych procesor moøliwo∂ci do
stworzenia przemy∂lanych filtrÛw pocztowych. Znane s± przypadki
uøywania Maildropa na serwerach z 30 000 kontami pocztowymi.

Lista dyskusyjna Maildropa: http://maildropl.listbox.com/ .

Ta wersja jest skompilowana z obs≥ug± plikÛw baz GDBM, rozszerzeniami
maildir (foldery i quoty) oraz userdb.

%package devel
Summary:	Development tools for handling E-mail messages
Summary(pl):	NarzÍdzia programisty do obs≥ugi wiadomo∂ci E-mail
Group:		Applications/Mail
Group(cs):	Aplikace/Poπta
Group(da):	Programmer/Post
Group(de):	Applikationen/Post
...
Ten pakiet zawiera biblioteki i pliki nag≥Ûwkowe przydatne przy
